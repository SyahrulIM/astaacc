                            ...
                            <tbody>
                                <?php foreach ($acc_accurate as $ackey => $acvalue) { ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url('accurate_recap/detail_acc?idacc_accurate=' . $acvalue->idacc_accurate) ?>"><button type="button" class="btn btn-success"><i class="fas fa-list"></i> Details</button></a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
