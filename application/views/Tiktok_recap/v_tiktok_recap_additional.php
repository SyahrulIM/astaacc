            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        <h1 class="mt-4">TikTok Additional</h1>
                    </div>
                </div>

                <!-- form periode -->
                <form action="<?= base_url('tiktok_additional/createAdditional') ?>" method="post">
                    <div class="card mt-3">
                        <div class="card-header">
                            <strong>Tambah Additional Revenue TikTok</strong>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="col">
                        <table id="tablepadditional" class="display" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                foreach ($acc_tiktok_additional->result() as $row) :
                                ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td>
